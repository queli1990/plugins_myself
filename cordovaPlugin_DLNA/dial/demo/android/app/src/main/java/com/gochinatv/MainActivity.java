...
public class MainActivity extends AppCompatActivity implements Discovery.Delegate {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.start).setOnClickListener(new View.OnClickListener() {
      public void onClick(View view) {
        for ( String name: get_hostname() ) {
          Result r = Dial.launch(name, "Netflix", "");
          ...
          Log.d("start", "code:"+ r.code + ", error:" + r.error);
        }
      }
    });
    ...
    findViewById(R.id.stop).setOnClickListener(new View.OnClickListener() {
      public void onClick(View view) {
        for ( String name: get_hostname() ) {
          Result r = Dial.stop(name, "Netflix");
          // MediaRenderer.stop(name);
          Log.d("stop", "code:"+ r.code + ", error:" + r.error);
        }
      }
    });
    ...
    findViewById(R.id.play).setOnClickListener(new View.OnClickListener() {
      public void onClick(View view) {
        for ( String name: get_hostname() ) {
          Result r = Dial.status(name, "Netflix");
          // Result r = MediaRenderer.play(name);
          Log.d("play", "code:"+ r.code + ", error:" + r.error);
        }
      }
    });
